...
function fcs = grid_all_quantities(z)
    ...
    flds = {...
        ...
        'chi1', 'chi2', 'chi', 'eps1_chi', 'eps2_chi', ...
        'N2', 'dTdz'};
        % 'nu', 'DT',
...
function fcs = manually_remove_bad_vals_4002(fcs)
    ...
    bad_ti = (...
        ...
        (t > datenum(2023, 6, 4, 15, 20, 0)) | ...
        (t > datenum(2023, 6, 2, 5, 40, 0) & fcs.isUP));
    fcs.eps1(:, bad_ti) = NaN;
    ...
    bad_ti = (...
        ...
        (t > datenum(2023, 6, 4, 14, 47, 0) & fcs.isUP) | ...
...
function fcs = manually_remove_bad_vals_4003(fcs)
    ...
    bad_ti = (...
        ...
        (t > datenum(2023, 6, 9, 18, 25, 0)));
    fcs.eps2(:, bad_ti) = NaN;

    % eps1_chi
    bad_ti = t > datenum(2023, 6, 21, 3, 0, 0);
...
function fcs = add_readme(fcs)
    ...
    fcs.readme = sprintf([...
        ...
        'Deployed during the May 2023 Arcterx cruise in the West Pacific Ocean.\n\n' ...
