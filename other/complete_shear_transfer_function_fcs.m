function H2k = complete_shear_transfer_function_fcs(f, W)
% function H2 = complete_shear_transfer_function_fcs(f, W)
%   Calculate H^2(k) that describes
%   1. variance lost at small scales by spatial averaging of the shear probe
